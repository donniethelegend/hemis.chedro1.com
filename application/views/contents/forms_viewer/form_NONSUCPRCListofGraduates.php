                                         ...
                                         <ul class="nav nav-tabs nav-tabs-top border-bottom-0">
                                               <?php
                                                      ...
                                                      foreach ($sheetnames as $sheetIndex => $sheetName) {
                                                                        ...
                                                                        echo '<li class="nav-item"><a href="'.base_url().'Checks_Attachment/NONSUCPRCListofGraduates/'.$checkid.'/'.$sheetIndex.'" class="nav-link '.($sheetName==$currentsheet?"active":"").'" >'.$sheetName.'</a></li>';
