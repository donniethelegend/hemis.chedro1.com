							...
							<div class="card-header header-elements-inline">
								<h5 class="card-title" >
                                                                ...
                                                                <h6> 
                                                                    <script>
                                                                        $(document).ready(function(){
                                                                            $.getJSON(site_url()+"Hei/hei_jsondata/"+<?= $check_dbrowdata[0]->instcode ?>, function(data){
                                                                                consoole.log(data)
                                         ...
                                         <ul class="nav nav-tabs nav-tabs-top border-bottom-0">
                                               <?php
                                                      ...
                                                      foreach ($sheetnames as $sheetIndex => $sheetName) {
                                                                        ...
                                                                        echo '<li class="nav-item"><a href="'.base_url().'Checks_Attachment/NONSUCFormE5FacultyForm/'.$checkid.'/'.$sheetIndex.'" class="nav-link '.($sheetName==$currentsheet?"active":"").'" >'.$sheetName.'</a></li>';
