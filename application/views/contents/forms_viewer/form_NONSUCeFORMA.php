                                         ...
                                         <ul class="nav nav-tabs nav-tabs-top border-bottom-0">
                                               <?php
                                                      ...
                                                      foreach ($sheetnames as $sheetIndex => $sheetName) {
                                                                        ...
                                                                        echo '<li class="nav-item"><a href="'.base_url().'Checks_Attachment/NONSUCeFormsA/'.$checkid.'/'.$sheetIndex.'" class="nav-link '.($sheetName==$currentsheet?"active":"").'" >'.$sheetName.'</a></li>';
						...
						<div class="modal-content">
							<div class="modal-header">
								...
								<button type="button" class="close" data-dismiss="modal">&times;</button>
                                                    ...
                                                    <form action="<?= base_url()?>Checks_Attachment/NONSUCeFormsA_consolidate/<?= $checkid ?>/<?php echo urlencode(base64_encode(base_url(uri_string()))) ?>"
                                                                                                          method="post" >
								<div class="modal-body">
									<div class="form-group">
										<div class="row">
