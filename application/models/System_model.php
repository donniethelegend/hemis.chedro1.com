...
class System_model extends CI_Model {
    ...
    function __construct() {
        	...
        	public function send_email($data,$temp_pass){
...
<p style="font-size: 42px; line-height: 1.2; word-break: break-word; text-align: center; font-family: inherit; mso-line-height-alt: 50px; margin: 0;"><span style="font-size: 42px; color: #2a272b;"><strong>CHED REGION 1 - StuFAPS!</strong></span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
<div style="line-height: 1.5; font-size: 12px; font-family: Helvetica Neue, Helvetica, Arial, sans-serif; color: #555555; mso-line-height-alt: 18px;">
    <p style="line-height: 1.5; word-break: break-word; text-align: center; font-family: inherit; font-size: 17px; mso-line-height-alt: 26px; mso-ansi-font-size: 18px; margin: 0;"><span style="font-size: 17px; mso-ansi-font-size: 18px;">Your password has been reset.<br/><br/>Temporary Password:<b>'.$temp_pass.'</b></span></p>
...
<!--[if (IE)]></div><![endif]-->
                ...
                $subject = 'CHED Scholarship Reset Password';
		$from = 'no-reply@stufaps.chedro1.com';
		$config['protocol'] = 'smtp';
		$config['smtp_host'] = 'ssl://stufaps.chedro1.com';
		$config['smtp_port'] = '465';
		$config['smtp_timeout'] = '60';

		$config['smtp_user'] = 'no-reply@stufaps.chedro1.com';
		$config['smtp_pass'] = '33eWzg8k7PqW';
		...
		if($data['email']!=""){
			...
			$this->email->from($from,'StuFAPs Scholarship Portal');
